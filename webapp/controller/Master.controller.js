sap.ui.define([
    ...
    return BaseController.extend("grctasks.controller.Master", {
        ...
        _showDetail: function (oItem) {
            ...
            if (oItem.getBindingContext().getProperty("CustomerID") === "Test4") {
                this.getRouter().navTo("reuseroute3");
            }else if (oItem.getBindingContext().getProperty("CustomerID") === "Test3") {
